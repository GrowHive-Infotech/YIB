        ...
        <div className="flex flex-col md:flex-row justify-between gap-6">
          ...
          <div className="footer-section">
            ...
            <ul className="text-sm space-y-2">
              ...
              <li><Link to="/blogs" className="hover:text-gray-400 text-white no-underline">Blogs</Link></li>
              <li><Link to="/jobs/all" className="hover:text-gray-400 text-white no-underline">Jobs</Link></li>
              <li><div onClick={()=>{
                dispatch(toggleForm(['login',true]));
              }}  className="hover:text-gray-400 text-white no-underline">Login</div></li>
              <li><div  onClick={()=>{
                dispatch(toggleForm(['signup',true]));
              }} className="hover:text-gray-400 text-white no-underline">Signup</div></li>
            </ul>
          </div>
